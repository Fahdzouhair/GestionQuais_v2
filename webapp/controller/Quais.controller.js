sap.ui.define([
    ...
    return Controller.extend("sd17appquaisv2.controller.Quais", {
        onInit() {
        ...
        loadDataAndSync: function() {
            ...
            oModel.read("/ZCDS_QUAIS_V2", {
                ...
                success: function(oDataAppQuais) {
                    ...
                    oModel.read("/ZCDS_STOCK_QUAIS_V2", {
                        urlParameters: {
                            "$top": that.iTop,
                            "$skip": that.iSkip
                        },
                        success: function(oDataStockQuais) {
                            ...
                            aNewEntries.forEach(function(oNewEntry) {
                                oModel.create("/ZCDS_QUAIS_V2", oNewEntry, {
                                    success: function() {
        ...
        onValueHelpRequest: function (oEvent) {
            ...
            if (sInputId.indexOf("filtreCodeArticle") !== -1) {
                if (!this._oProductVHDialog) {
                    this._oProductVHDialog = sap.ui.xmlfragment("sd17appquaisv2.fragments.ProductVHDialog", this);
                ...
                if (!this._oPlantVHDialog) {
                    this._oPlantVHDialog = sap.ui.xmlfragment("sd17appquaisv2.fragments.PlantVHDialog", this);
                ...
                if (!this._oMagasinVHDialog) {
                    this._oMagasinVHDialog = sap.ui.xmlfragment("sd17appquaisv2.fragments.MagasinVHDialog", this);
